...
export default function IntegrationSection() {
  ...
  return (
    <section className="max-w-[1200px] flex flex-col mx-auto mt-10 mb-40 px-6 md:px-0">
      {/* Grid Image */}
      ...
      {/* Content Section */}
      <div className="flex flex-col justify-between md:flex-row gap-10 pt-20">
        {/* Left Section */}
          ...
          {features.map((feature, index) => (
            <div key={index} className="flex items-center gap-2">
              <Image
                ...
                height={40}
              />
              <span className="text-lg md:text-xl text-primary dark:text-white font-normal">
                {feature}
              </span>
            </div>
          ))}
