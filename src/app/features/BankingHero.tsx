...
export default function BankingHero() {
  return (
    <section className="bg-[#E8F2EE] py-10 md:py-28 dark:bg-white px-6 md:px-0">
      <div className="max-w-[1200px]  mx-auto  flex flex-col lg:flex-row items-center justify-between gap-10 transition-all">
        ...
        <div className="text-start md:text-center lg:text-left">
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold text-primary dark:text-black">
          ...
          {/* Features List */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 text-base md:text-lg font-medium my-12">
            {[
          ...
          {/* Buttons */}
          <div className="mt-6 flex flex-col md:flex-row items-start md:items-center sm:space-x-4 space-y-4 sm:space-y-0">
