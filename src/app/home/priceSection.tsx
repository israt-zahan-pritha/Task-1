...
export default function PriceSection() {
  return (
    <section className="flex flex-col  items-center justify-center py-32 px-6">
      ...
      <h1 className="text-5xl sm:text-6xl md:text-7xl  text-center  font-medium">
        Choose your card.
      </h1>

      <p className="text-[20px] pt-4 font-medium text-center max-w-[800px]">
        Senectus et netus et malesuada fames ac turpis.
        <br /> Sagittis vitae et leo duis ut diam.
      </p>

      {/* Pricing Plans */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 max-w-[1200px] w-full">
        ...
        {[
          ...
          <div
            key={index}
            className="text-center p-6 border border-gray-200 rounded-lg shadow-lg"
          >
            <h3 className="text-[20px] font-medium flex items-center justify-center gap-2">
              {name}
              {badge && (
